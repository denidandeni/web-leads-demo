        ...
        <div className="space-y-8 animate-in slide-in-from-bottom-8 duration-500 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="border border-stone-200 bg-white rounded-3xl p-8 shadow-xl shadow-stone-200/40 space-y-8 relative overflow-hidden">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="border border-stone-200 bg-white rounded-3xl p-6 shadow-xl shadow-stone-200/40 relative overflow-hidden">
                    ...
                    {/* Score Hero Card */}
                    <div className="border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white rounded-3xl p-8 shadow-lg shadow-emerald-100/50 flex flex-col sm:flex-row items-center justify-between gap-8 relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-2 text-center sm:text-left">
                            ...
                            <h3 className="text-5xl font-extrabold text-emerald-900 tracking-tight">{contact.score}<span className="text-2xl opacity-50 font-medium"> / 100</span></h3>
                    ...
                    {/* Q&A List */}
                    <div className="border border-stone-200 bg-white rounded-3xl p-8 shadow-xl shadow-stone-200/40 space-y-6">
                        ...
                        <div className="space-y-4">
                            {contact.answers.map((item, idx) => (
                                <div key={idx} className="bg-stone-50/80 border border-stone-100 p-5 rounded-2xl flex flex-col gap-3 hover:border-amber-200 hover:bg-amber-50/30 transition-colors group">
                                    ...
                                    <div className="flex justify-between items-start gap-4 pl-10 border-t border-stone-200/60 pt-3">
                                        <p className="text-sm font-medium text-stone-600 bg-white px-4 py-2 rounded-xl shadow-sm border border-stone-100 flex-1">{item.a}</p>
